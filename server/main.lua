            ...
            if biller.PlayerData.citizenid ~= billed.PlayerData.citizenid then
                if amount and amount > 0 then
                    if billed.Functions.RemoveMoney('bank', amount, 'paid-fine') then
                        ...
                        exports['okokBanking']:AddMoney(biller.PlayerData.job.name, amount, 'Fine')
...
RegisterNetEvent('police:server:EscortPlayer', function(playerId)
    ...
    if (Player.PlayerData.job.type == 'leo' or Player.PlayerData.job.name == 'ambulance') or (EscortPlayer.PlayerData.metadata['ishandcuffed'] or EscortPlayer.PlayerData.condition.in_dead or EscortPlayer.PlayerData.condition.in_last_stand) then
...
RegisterNetEvent('police:server:KidnapPlayer', function(playerId)
    ...
    if EscortPlayer.PlayerData.metadata['ishandcuffed'] or EscortPlayer.condition.in_dead or EscortPlayer.PlayerData.condition.in_last_stand then
...
RegisterNetEvent('police:server:SetPlayerOutVehicle', function(playerId)
    ...
    if EscortPlayer.PlayerData.metadata['ishandcuffed'] or EscortPlayer.condition.in_dead then
...
RegisterNetEvent('police:server:PutPlayerInVehicle', function(playerId)
    ...
    if EscortPlayer.PlayerData.metadata['ishandcuffed'] or EscortPlayer.PlayerData.condition.in_dead then
...
RegisterNetEvent('police:server:BillPlayer', function(playerId, price)
    ...
    exports['okokBanking']:AddMoney('police', price, 'Fine paid')
